  ...
  return (
    <section className="mt-16 mb-32 rounded-3xl bg-blue-50 p-10 mx-24">
      ...
      <div className="mt-8 flex justify-center relative">
        <div className="absolute top-[1.5rem] w-[70%] text-transparent border-t border-yellow-700 h-4 border-dashed"></div>
      ...
      <div className="flex justify-center">
        <div className="mt-16 shadow bg-white rounded-xl w-[50rem] p-6 py-24 relative">
          ...
          <div className="border-t border-yellow-700 h-1 absolute top-[50%]  w-[93%]"></div>
        </div>
      </div>
    </section>
  );
